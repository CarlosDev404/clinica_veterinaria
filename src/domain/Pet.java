...
public class Pet {
    ...
    public String toString() {
        return "Pet [codigo=" + codigo + ", nome=" + nome + ", dataNascimento=" + dataNascimento + ", genero=" + genero
                + ", tutor=" + tutor + ", especie=" + especie + ", getCodigo()=" + getCodigo() + ", getNome()="
                + getNome() + ", getDataNascimento()=" + getDataNascimento() + ", getGenero()=" + getGenero()
                + ", getTutor()=" + getTutor() + ", getEspecie()=" + getEspecie() + ", getClass()=" + getClass()
